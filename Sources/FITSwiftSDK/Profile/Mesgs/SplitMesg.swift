...
open class SplitMesg : Mesg {
	...
	public func getActiveTime() -> Float64? {
		guard let value = getFieldValue(fieldNum: SplitMesg.activeTimeFieldNum, index:0) as? Float64 else {
            return nil
        }
		return value
	}
	...
	public func setActiveTime(_ value: Float64) throws {
		try setFieldValue(fieldNum: SplitMesg.activeTimeFieldNum, value: value)
	}
	...
	public class func createSplitMesg() -> SplitMesg {
		...
		mesg.fields[SplitMesg.activeTimeFieldNum] = Field(name: "ActiveTime", num: SplitMesg.activeTimeFieldNum, type: BaseType.UINT32.rawValue, scale: 1000, offset: 0, units: "s", accumulated: false)
