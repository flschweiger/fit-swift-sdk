...
open class MonitoringMesg : Mesg {
    ...
    public static let pushesFieldNum:UInt8 = 41
	...
	public func getPushes() -> UInt32? {
		guard let value = getFieldValue(fieldNum: MonitoringMesg.pushesFieldNum, index:0) as? UInt32 else {
            return nil
        }
		return value
	}

	public func setPushes(_ value: UInt32) throws {
		try setFieldValue(fieldNum: MonitoringMesg.pushesFieldNum, value: value)
	}
	...
	public class func createMonitoringMesg() -> MonitoringMesg {
		...
		mesg.fields[MonitoringMesg.pushesFieldNum] = Field(name: "Pushes", num: MonitoringMesg.pushesFieldNum, type: BaseType.UINT32.rawValue, scale: 1, offset: 0, units: "", accumulated: false)
        return mesg
    }
}