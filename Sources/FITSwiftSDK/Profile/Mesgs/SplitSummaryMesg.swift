...
open class SplitSummaryMesg : Mesg {
    ...
    public static let activeTimeFieldNum:UInt8 = 65
	...
	public func getActiveTime() -> Float64? {
		guard let value = getFieldValue(fieldNum: SplitSummaryMesg.activeTimeFieldNum, index:0) as? Float64 else {
            return nil
        }
		return value
	}
	...
	public func setActiveTime(_ value: Float64) throws {
		try setFieldValue(fieldNum: SplitSummaryMesg.activeTimeFieldNum, value: value)
	}
	...
	public class func createSplitSummaryMesg() -> SplitSummaryMesg {
		...
		mesg.fields[SplitSummaryMesg.activeTimeFieldNum] = Field(name: "ActiveTime", num: SplitSummaryMesg.activeTimeFieldNum, type: BaseType.UINT32.rawValue, scale: 1000, offset: 0, units: "s", accumulated: false)
