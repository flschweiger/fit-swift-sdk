...
open class SessionMesg : Mesg {
    ...
    public static let activeTimeFieldNum:UInt8 = 78
	...
	private struct TotalCyclesSubField {
        public static let totalReps:UInt16 = 0
        public static let totalStrides:UInt16 = 1
        public static let totalStrokes:UInt16 = 2
        public static let totalPushes:UInt16 = 3
	...
	public func getTotalReps() throws -> UInt32? {
		guard let value = try getFieldValue(fieldNum: SessionMesg.totalCyclesFieldNum, index: 0, subFieldIndex: TotalCyclesSubField.totalReps).map({UInt32(fitValue: $0)}) else {
			return nil
		}
	...
	public func setTotalReps(_ value: UInt32) throws {
		try setFieldValue(fieldNum: SessionMesg.totalCyclesFieldNum, value: value, index: 0, subFieldIndex: TotalCyclesSubField.totalReps )
	}
	...
	public func getTotalPushes() throws -> UInt32? {
		guard let value = try getFieldValue(fieldNum: SessionMesg.totalCyclesFieldNum, index: 0, subFieldIndex: TotalCyclesSubField.totalPushes).map({UInt32(fitValue: $0)}) else {
			return nil
		}
	...
	public func setTotalPushes(_ value: UInt32) throws {
		try setFieldValue(fieldNum: SessionMesg.totalCyclesFieldNum, value: value, index: 0, subFieldIndex: TotalCyclesSubField.totalPushes )
	}
	...
	public func getActiveTime() -> Float64? {
		guard let value = getFieldValue(fieldNum: SessionMesg.activeTimeFieldNum, index:0) as? Float64 else {
            return nil
        }
		return value
	}
	...
	public func setActiveTime(_ value: Float64) throws {
		try setFieldValue(fieldNum: SessionMesg.activeTimeFieldNum, value: value)
	}
	...
	public class func createSessionMesg() -> SessionMesg {
        ...
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields.append(SubField(name: "TotalReps", type: BaseType.UINT32.rawValue, scale: 1, offset: 0, units: "reps"))
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields[Int(TotalCyclesSubField.totalReps)].addMap(refFieldNum: 6, refFieldValue: 20)
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields[Int(TotalCyclesSubField.totalReps)].addMap(refFieldNum: 5, refFieldValue: 62)
        ...
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields.append(SubField(name: "TotalPushes", type: BaseType.UINT32.rawValue, scale: 1, offset: 0, units: "pushes"))
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields[Int(TotalCyclesSubField.totalPushes)].addMap(refFieldNum: 5, refFieldValue: 66)
        mesg.fields[SessionMesg.totalCyclesFieldNum]?.subFields[Int(TotalCyclesSubField.totalPushes)].addMap(refFieldNum: 5, refFieldValue: 65)
		...
		mesg.fields[SessionMesg.activeTimeFieldNum] = Field(name: "ActiveTime", num: SessionMesg.activeTimeFieldNum, type: BaseType.UINT32.rawValue, scale: 1000, offset: 0, units: "s", accumulated: false)
