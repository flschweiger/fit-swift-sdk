...
open class LapMesg : Mesg {
    ...
    public static let activeTimeFieldNum:UInt8 = 70
	...
	public func getActiveTime() -> Float64? {
		guard let value = getFieldValue(fieldNum: LapMesg.activeTimeFieldNum, index:0) as? Float64 else {
            return nil
        }
		return value
	}
	...
	public func setActiveTime(_ value: Float64) throws {
		try setFieldValue(fieldNum: LapMesg.activeTimeFieldNum, value: value)
	}
	...
	public class func createLapMesg() -> LapMesg {
		...
		mesg.fields[LapMesg.activeTimeFieldNum] = Field(name: "ActiveTime", num: LapMesg.activeTimeFieldNum, type: BaseType.UINT32.rawValue, scale: 1000, offset: 0, units: "s", accumulated: false)
